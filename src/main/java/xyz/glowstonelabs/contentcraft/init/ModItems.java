...
public class ModItems {
    ...
    public static final Item XAENON_AXE = registerItem("xaenon_axe",
            new ShovelItem(ModTools.XAENON, new Item.Settings()
                    .attributeModifiers(ShovelItem.createAttributeModifiers(ModTools.XAENON, 1.5f, -3.0f))));public static final Item XAENON_HOE = registerItem("xaenon_hoe",
    ...
    public static final Item BLUE_BERRIES = registerItem("blue_berries",
            new AliasedBlockItem(ModBlocks.BLUEBERRY_BUSH, new Item.Settings().food(ModFoods.BLUEBERRY_COMPONENT)));

    // In your ModItems class
    public static final Item OAK_BARK = registerItem("oak_bark",
            new BarkItem(new Item.Settings(), ModBarkTypes.OAK_BLOCKS));

    public static final Item BIRCH_BARK = registerItem("birch_bark",
            new BarkItem(new Item.Settings(), ModBarkTypes.BIRCH_BLOCKS));

    public static final Item SPRUCE_BARK = registerItem("spruce_bark",
            new BarkItem(new Item.Settings(), ModBarkTypes.SPRUCE_BLOCKS));

    public static final Item DARK_OAK_BARK = registerItem("dark_oak_bark",
            new BarkItem(new Item.Settings(), ModBarkTypes.DARK_OAK_BLOCKS));

    public static final Item ACACIA_BARK = registerItem("acacia_bark",
            new BarkItem(new Item.Settings(), ModBarkTypes.ACACIA_BLOCKS));

    public static final Item JUNGLE_BARK = registerItem("jungle_bark",
            new BarkItem(new Item.Settings(), ModBarkTypes.JUNGLE_BLOCKS));

    public static final Item MANGROVE_BARK = registerItem("mangrove_bark",
            new BarkItem(new Item.Settings(), ModBarkTypes.MANGROVE_BLOCKS));

    public static final Item CHERRY_BARK = registerItem("cherry_bark",
            new BarkItem(new Item.Settings(), ModBarkTypes.CHERRY_BLOCKS));

    public static final Item WARPED_BARK = registerItem("warped_bark",
            new BarkItem(new Item.Settings(), ModBarkTypes.WARPED_BLOCKS));

    public static final Item CRIMSON_BARK = registerItem("crimson_bark",
            new BarkItem(new Item.Settings(), ModBarkTypes.CRIMSON_BLOCKS));

    public static final Item MAPLE_BARK = registerItem("maple_bark",
            new BarkItem(new Item.Settings(), ModBarkTypes.MAPLE_BLOCKS));
