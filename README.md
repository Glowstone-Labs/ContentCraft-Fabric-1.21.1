...
![logo](src/main/resources/assets/contentcraft/icon.png)
...
![Enviroment](https://img.shields.io/badge/Enviroment-Both-red)
[![Minecraft Version](https://img.shields.io/badge/1.21%7C1.21.1-62B957?logo=minecraft&logoColor=ffffff&label=Minecraft&labelColor=1E1E1E&style=flat)]()
[![Discord](https://img.shields.io/discord/1249410048963252224?label=Discord&logo=discord&logoColor=ffffff&labelColor=5865F2&color=36393F&style=flat)](https://discord.gg/zkyvsB3xAz)
[![Modrinth Downloads](https://img.shields.io/modrinth/dt/contentcraft?logo=modrinth&label=&suffix=Downloads&style=flat&color=242629&labelColor=5ca424&logoColor=1c1c1c)](https://modrinth.com/mod/ccontentcraft)

  ___

ContentCraft is a feature-rich Fabric mod for Minecraft 1.21.x that expands the game with over 50 new blocks, items, and tools designed to enrich survival, exploration, and building. This mod focuses on adding balanced, well-integrated materials and crafting progressions that blend naturally with the vanilla experience, providing fresh gameplay without compromising performance or compatibility.

Whether you want new ores to mine, decorative building blocks, or quality-of-life items, ContentCraft delivers diverse content without compromising 

---

## ✨ Features  

### ⚔️ Xaenon Material System  
- **New Ore Generation**: Find Xaenon Ore deep underground  
- **Powerful Gear**: Tools and armor with unique stats  
- **Decorative Blocks**: Metallic building variants  

### 💎 Artificial Diamond  
- **Synthetic Diamond**: Craftable alternative to diamonds  
- **Full Toolset**: Pickaxes, swords, and more  
- **Tech Blocks**: Futuristic building options  

### 🍁 Maple Wood Set  
- **New Wood Type**: Complete building set (planks, stairs, slabs)  
- **Custom Textures**: Vibrant orange leaves and bark  

### 🛠️ Quality of Life  
- **Dirt/Grass Slabs**: Smoother terrain transitions  
- **Trowel Tool**: Fast landscaping  
- **Boiled Eggs**: New food option  
...
2. Download [ContentCraft.jar](https://modrinth.com/mod/contentcraft)  
...
dependencies {
    modImplementation "maven.modrinth:contentcraft:1.0.0"
}
